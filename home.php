...
<body>
  ...
  <!-- Links -->
	...
	<div class="background">
		<i class="fa fa-quote-left"></i><p>Give a man a fish and you feed him for a day; teach a man to fish and you feed him for a lifetime.</p>
	</div>
	<div class="background">
			...
			//{
				...
				//{
					...
					else if($board>=60)
					{
						...
						//else echo "Sorry, you're not eligible for Indian Institute of Technology.<br>";
						if($avg>60)
							echo "You are eligible to apply for National Institute of Technology.<br>";
						//else echo "Sorry, you're not eligible for National Institute of Technology.<br>";
						if($bits>280)
							echo "You are eligible to apply for Birla Institute of Technology and Science.<br>";
						//else echo "Sorry, you're not eligible for Birla Institute of Technology and Science.<br>";
						if($srm>140)
							echo "You are eligible to apply for Sri Ramaswamy Memorial.<br>";
						//else echo "Sorry, you're not eligible for Sri Ramaswamy Memorial.<br>";
						if($vit>80)
							echo "You are eligible to apply for Vellore Institute of Technology.<br>";
						//else echo "Sorry, you're not eligible for Vellore Institute of Technology.<br>";
					} 
